...
TRACE_POC1=/home/cris/Documents/0_Projects/m-step/evaluation/traces/tfm-rsa-gen-poc-001/log.txt
TRACE_POC2=/home/cris/Documents/0_Projects/m-step/evaluation/traces/tfm-rsa-dec-poc-002/log.txt

echo -e "${ORANGE}#------------------------------------------------------------------------${NC}"
echo -e "${YELLOW}POC#1${NC}"
echo -e "${ORANGE}#------------------------------------------------------------------------${NC}"
echo -e "${GREEN}Expected Private Key${NC}"
echo -e "${ORANGE}#------------------------------------------------------------------------${NC}"
# Get the generated key from  mbedtls key gen function
# grep -E '^\s*(p|q) =' ${TRACE_POC1}
${ANALYZER}/1-analyze-trace.sh -t ${TRACE_POC1}
echo -e "${ORANGE}#------------------------------------------------------------------------${NC}"
echo -e "${GREEN} Recovered Private Key${NC}"
echo -e "${ORANGE}#------------------------------------------------------------------------${NC}"
${ANALYZER}/1-analyze-trace.sh -t ${TRACE_POC1}
echo -e "${ORANGE}#------------------------------------------------------------------------${NC}"
